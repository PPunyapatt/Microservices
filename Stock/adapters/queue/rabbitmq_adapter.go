...
type RabbitMQAdapter interface {
	...
	Consume(queueName string, topics []string, orderUsecase entities.StockUsecases) error
}
...
func (r *rabbitMQAdapter) Consume(queueName string, topics []string, orderUsecase entities.StockUsecases) error {
